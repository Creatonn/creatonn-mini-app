    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6">
            <div className='w-full flex justify-end'>
                <div className="w-1/4 flex items-center bg-white rounded-full mb-4">
            ...
            <div className="user-posts w-full max-w-5xl flex flex-col items-center justify-center mt-8">
                <img
