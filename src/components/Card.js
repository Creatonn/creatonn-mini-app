...
const Card = ({ imgSrc, title, description, profileImgSrc }) => {
    return (
        <div className="bg-custom-gray p-6 rounded-lg shadow-md flex flex-col border-2 border-black h-[85vh] max-h-[500px]">
            ...
            <p className="text-lg text-justify mb-4 font-sans text-card-description">{description}</p>
